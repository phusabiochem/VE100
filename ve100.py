...
def camera_preview():
	...
	camera.shutter_speed = 5000000
	camera.exposure_mode = 'sports'
	camera.start_preview(alpha=255, fullscreen=False, window=(147, 29, 850,500))
# CAMERA - END
...
def main():
	...
	menu_labelframe =  LabelFrame(root, bg=TASKBAR_BACKGROUND_COLOR, width=1023, height=55)
	menu_labelframe.place(x=1,y=545)
...
#         exit_button['bg'] = MAINMENU_BUTTON_DISABLE_COLOR
		...
		run_labelframe =  LabelFrame(root, bg=MAIN_BACKGROUND_COLOR, width=1023, height=545)
		run_labelframe.place(x=1,y=1)

		run_label =  Label(run_labelframe, text="RUN", font=("Arial",16, "bold"), fg=LABEL_TEXT_COLOR_1, bg=LABEL_BACKGROUND_COLOR_1, width=84, height=2)
		run_label.place(x=4,y=1)
		ve100_label = Label(run_labelframe, text="VE100", font=("Arial",16, "bold"), fg=LABEL_TEXT_COLOR_2, bg=LABEL_BACKGROUND_COLOR_2, width=10, height=2)
		ve100_label.place(x=2,y=1)

		mode_labelframe = LabelFrame(run_labelframe, bg=MAIN_BACKGROUND_COLOR, width=700, height=330, text="Run Mode", font=(13))
		mode_labelframe.place(x=157,y=125)

		def singlestage_clicked():
			folder_labelframe = LabelFrame(mode_labelframe,
												# width = 700,
												# height = 320,
												text = "Folder Name [Single Stage]",
												bg = 'dodger blue')
			folder_labelframe.place(x=0, y=10)

			folder_name_entry = Entry(folder_labelframe, width=50, justify='right', font=(15))
			folder_name_entry.pack(padx=40, pady=50)
			...
			ok_button = Button(folder_labelframe,
						...
						borderwidth = 0,
						command = ok_clicked)
			ok_button.pack(side=LEFT, padx=100, pady=50, ipady=10, ipadx=35)
			...
			cancel_button.pack(side=RIGHT, padx=100, pady=50, ipady=10, ipadx=35)

		def multistage_clicked():
			folder_labelframe = LabelFrame(mode_labelframe,
												# width = 700,
												# height = 320,
												text = "Folder Name [Multi Stage]",
												bg = 'dodger blue')
			folder_labelframe.place(x=0, y=10)
		...
		singlestage_button = Button(mode_labelframe, bg=BUTTON_BACKGROUND_COLOR_1, fg=BUTTON_TEXT_COLOR_1, bd=0, text='Single Stage', font=(13), width=19, height=5, command=singlestage_clicked)
		singlestage_button.place(x=80,y=100)
		multistage_button = Button(mode_labelframe, bg=BUTTON_BACKGROUND_COLOR_1, fg=BUTTON_TEXT_COLOR_1, bd=0, text='Multi Stage', font=(13), width=19, height=5, command=multistage_clicked)
		multistage_button.place(x=395,y=100)
...
#         exit_button['bg'] = MAINMENU_BUTTON_DISABLE_COLOR
		...
		viewresults_labelframe =  LabelFrame(root, bg=MAIN_BACKGROUND_COLOR, width=1023, height=545)
		viewresults_labelframe.place(x=1,y=1)
		viewresults_label =  Label(viewresults_labelframe, text="BAND FINDER", font=("Arial",16, "bold"), fg=LABEL_TEXT_COLOR_1, bg=LABEL_BACKGROUND_COLOR_1, width=84, height=2)
		viewresults_label.place(x=4,y=1)
		ve100_label = Label(viewresults_labelframe, text="VE100", font=("Arial",16, "bold"), fg=LABEL_TEXT_COLOR_2, bg=LABEL_BACKGROUND_COLOR_2, width=10, height=2)
		ve100_label.place(x=2,y=1)
...
#             menu_labelframe.place_forget()
			...
			# ~ control_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=300, height=70)
			# ~ control_labelframe.place(x=38,y=340)
			control0_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=350, height=70)
			control0_labelframe.place(x=19, y=458)
			control1_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=200, height=70)
			control1_labelframe.place(x=327,y=458)
			control2_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=350, height=78)
			control2_labelframe.place(x=489, y=458)
			control3_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=200, height=70)
			control3_labelframe.place(x=836, y=458)
			# ~ control4_labelframe = LabelFrame(viewresults_labelframe, text='Note',bg=FRAME_BACKGROUND_COLOR_1, fg='blue', width=80, height=70)
			# ~ control4_labelframe.place(x=688, y=340)
			...
			def draw_line_1(value=None):
				...
				try:
					...
					pass
				line1 = image_canvas.create_line(1, line1_value.get(), 922,  line1_value.get(), fill="dodger blue", width=1)
			...
			def draw_line_2(value=None):
				...
				try:
					...
					pass
				line2 = image_canvas.create_line(1, line2_value.get(), 922,  line2_value.get(), fill="red", width=1)
...
#                 b_value = line1_value.get() - math.log(2000)*a_value
				...
				band_line = image_canvas.create_line(1, bandline_value.get(), 922,  bandline_value.get(), fill="green2", width=1)


			band_value_slidebar = Scale(viewresults_labelframe, variable=bandline_value, from_=1, to=369, bg="green2", orient=VERTICAL, length=280, command=draw_line_3)
			lower_band_slidebar = Scale(viewresults_labelframe, variable=line2_value, from_=1, to=369, bg="red", orient=VERTICAL, length=398, command=draw_line_2)
			lower_band_slidebar.place(x=947, y=56)
			higher_band_slidebar = Scale(viewresults_labelframe, variable=line1_value, from_=1, to=369, bg="dodger blue", orient=VERTICAL, length=398, command=draw_line_1)
			higher_band_slidebar.place(x=927, y=56)

			image0_canvas = Canvas(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=939, height=399)
			image0_canvas.place(x=18, y=56)
			global image_canvas
			image_canvas = Canvas(viewresults_labelframe, bg='grey35', width=922, height=369)
			image_canvas.place(x=35, y=72)

			band_label = Label(control2_labelframe, text="Band size", bg=FRAME_BACKGROUND_COLOR_1)
			band_label.place(x=22,y=8)
			band_entry = Entry(control2_labelframe, state='disable', justify='center',width=9, font=('Courier',20))
			band_entry.place(x=22,y=30)
			...
			def find_clicked():
				...
				first_band_value = int(firstband_entry.get())
				last_band_value = int(lastband_entry.get())
				
				
				if(band_entry.get()==''):
					msg = messagebox.showwarning("", "You haven't chosen a band yet !")
				elif(int(band_entry.get()) > first_band_value or int(band_entry.get()) < last_band_value):
					msg = messagebox.showwarning("", "Band size must be between first and last band value !")
				else:
					save_button['state'] = 'normal'

					a_value = round((line2_value.get() - line1_value.get())/(math.log10(last_band_value) - math.log10(first_band_value)),2)
					b_value = round(line1_value.get() - math.log10(first_band_value)*a_value,2)
...
#                     final_img.save(name+'.png', 'png')
			...
			firstband_label = Label(control0_labelframe, text="First band", fg ="dodger blue", font=('Arial', 12))
			firstband_label.grid(row=0, column=0, padx=35, pady=4) 
			lastband_label = Label(control0_labelframe, text="Last band ", fg ="red", font=('Arial', 12))
			lastband_label.grid(row=1, column=0, padx=35, pady=4) 
			
			firstband_entry = Entry(control0_labelframe, justify='right', width=10, font=('Arial',12))
			firstband_entry.grid(row=0, column=1, padx=34, pady=6)
			firstband_entry.insert(0, 2000)
			lastband_entry = Entry(control0_labelframe, justify='right', width=10, font=('Arial',12))
			lastband_entry.grid(row=1, column=1, padx=34, pady=6)
			lastband_entry.insert(0, 100)
			
			open_button = Button(control1_labelframe, text='Open', font=('Arial', 13), fg=BUTTON_TEXT_COLOR_1, bg=BUTTON_BACKGROUND_COLOR_2, borderwidth=2, width=10, height=2, command=open_clicked)
			open_button.pack(padx=15, pady=9)

			find_button = Button(control2_labelframe, state='disable', text='Find', font=('Arial', 13), fg=BUTTON_TEXT_COLOR_1, bg=BUTTON_BACKGROUND_COLOR_2, borderwidth=2, width=10, height=2, command=find_clicked)
			find_button.place(x=195,y=10)
			save_button = Button(control3_labelframe, state='disable',text='Save', font=('Arial', 13), fg=BUTTON_TEXT_COLOR_1, bg=BUTTON_BACKGROUND_COLOR_2, borderwidth=2, width=10, height=2, command=save_clicked)
			save_button.pack(padx=15, pady=9)

			# ~ note1_label = Label(control4_labelframe, text="First Band", fg ="dodger blue", bg='grey88')
			# ~ note1_label.pack(padx=7, pady=1)
			# ~ note2_label = Label(control4_labelframe, text="Last Band", fg ="red", bg='grey88')
			# ~ note2_label.pack(padx=7, pady=2)
...
#         exit_button['bg'] = MAINMENU_BUTTON_DISABLE_COLOR
		...
		account_labelframe =  LabelFrame(root, bg=MAIN_BACKGROUND_COLOR, width=1023, height=545)
		account_labelframe.place(x=1,y=1)
		account_label =  Label(account_labelframe, text="ACCOUNT", font=("Arial", 16, "bold"), fg=LABEL_TEXT_COLOR_1, bg=LABEL_BACKGROUND_COLOR_1, width=84, height=2)
		account_label.place(x=4,y=1)
		ve100_label = Label(account_labelframe, text="VE100", font=("Arial", 16, "bold"), fg=LABEL_TEXT_COLOR_2, bg=LABEL_BACKGROUND_COLOR_2, width=10, height=2)
		ve100_label.place(x=2,y=1)

		email_label = Label(account_labelframe, bg=MAIN_BACKGROUND_COLOR, text='Email', font=('Arial', 15))
		email_label.place(x=267, y=240)
		email_entry = Entry(account_labelframe, justify='right', width=32, font=('Arial',15))
		email_entry.place(x=377,y=239)
		password_label = Label(account_labelframe, bg=MAIN_BACKGROUND_COLOR, text='Password', font=('Arial', 15))
		password_label.place(x=267, y=290)
		password_entry = Entry(account_labelframe, show='◼', justify='right',width=32, font=('Arial',15))
		password_entry.place(x=377,y=289)
		login_label = Label(account_labelframe, bg=MAIN_BACKGROUND_COLOR, fg="grey30", font=("Arial", 15))
...
#                 password_entry.insert(0,text)
		...
		hidepass_checkbutton.place(x=610,y=322)

		if(account_active):
			login_label['fg'] = "green4"
			login_label['text'] = 'YOU ARE ALREADY LOGGED IN ✔'
			login_label.place(x=352, y=140)
			...
			logout_button.place(x=438,y=370)
		else:
			login_label['text'] = 'USER LOGIN'
			login_label.place(x=445, y=140)
			def save_click():
				if(email_entry.get()==''):
			...
			save_button = Button(account_labelframe, bg=BUTTON_BACKGROUND_COLOR_1, bd=0, text='Login', font=(13), width=12, height=3, command=save_click)
			save_button.place(x=438,y=370)
...
#         ve100_label.place(x=0,y=1)
	...
	run_button = Button(menu_labelframe, text='RUN', font=('Arial', 12, 'bold'), fg='black', bg=MAINMENU_BUTTON_DISABLE_COLOR, borderwidth=0, width=29, height=2, command=run_clicked)
	run_button.place(x=2,y=0)
	viewresults_button = Button(menu_labelframe, text='BAND FINDER', font=('Arial', 12, 'bold'), fg='black', bg=MAINMENU_BUTTON_DISABLE_COLOR, borderwidth=0, width=29, height=2, command=viewresults_clicked)
	viewresults_button.place(x=289,y=0)
	account_button = Button(menu_labelframe, text='ACCOUNT', font=('Arial', 12, 'bold'), fg='black', bg=MAINMENU_BUTTON_DISABLE_COLOR, borderwidth=0, width=29, height=2, command=account_clicked)
	account_button.place(x=576,y=0)
	exit_button = Button(menu_labelframe, text='EXIT', font=('Arial', 12, 'bold'), fg='black', bg='firebrick3', borderwidth=0, width=14, height=2, command=exit_clicked)
	exit_button.place(x=865,y=0)
...
def namingScreen():
	...
	naming_labelframe = LabelFrame(root, bg=MAIN_BACKGROUND_COLOR, width=1023, height=599)
	naming_labelframe.place(x=1,y=1)
	naming_title_label =  Label(naming_labelframe, text="SETTINGS", font=("Arial", 16, "bold"), fg=LABEL_TEXT_COLOR_1, bg=LABEL_BACKGROUND_COLOR_1, width=84, height=2)
	naming_title_label.place(x=3,y=1)

	number_of_wells_label = Label(naming_labelframe, text="Number of wells", font=("Arial", 13), bg=MAIN_BACKGROUND_COLOR, fg='black')
	number_of_wells_label.place(x=10, y=70)

	wells_17_labelframe = LabelFrame(naming_labelframe, bg=MAIN_BACKGROUND_COLOR, width=700, height=400)
...
#             well_entry_list_26[1].focus_set()
	...
	def check_option(eventObject):
		if(number_of_wells_combobox.current() == 0):
			...
			try:
				...
				pass
			wells_17_labelframe.place(x=2,y=115)
			...
			try:
				...
				pass
			wells_26_labelframe.place(x=2,y=115)
		else:
			try:
				wells_17_labelframe.place_forget()
			except:
			...
			try:
				...
				pass
			wells_34_labelframe.place(x=2,y=115)
	...
	number_of_wells_combobox.place(x=175, y=72)
	...
	def next_click():
		...
		if(err==0):
			if(multi_chosen == 1):
				...
				oneStepRunScreen()
	back_button = Button(naming_labelframe, bd=1, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), text='BACK', width=12, height=3, command=back_click)
	back_button.place(x=0,y=532)
	next_button = Button(naming_labelframe, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), bd=1,text='NEXT', width=12, height=3, command=next_click)
	next_button.place(x=907,y=532)
...
def multiStepRunScreen():
	...
	global multirunscreen_labelframe0
	multirunscreen_labelframe0 = LabelFrame(root, bg=MAIN_BACKGROUND_COLOR, width=1023, height=599)
	multirunscreen_labelframe0.place(x=1, y=1)
	multirunscreen_title_label =  Label(multirunscreen_labelframe0, text="SETTINGS", font=("Arial",16, "bold"), fg=LABEL_TEXT_COLOR_1, bg=LABEL_BACKGROUND_COLOR_1, width=84, height=2)
	multirunscreen_title_label.place(x=3, y=1)


	setting1_labelframe = LabelFrame(multirunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_1, fg=FRAME_TEXT_COLOR_1, text='STAGE 1', font=('Arial',13), width=337, height=460)
	setting1_labelframe.place(x=1,y=60)
	setting2_labelframe = LabelFrame(multirunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_1, fg=FRAME_TEXT_COLOR_1, text='STAGE 2', font=('Arial',13), width=338, height=460)
	setting2_labelframe.place(x=340,y=60)
	setting3_labelframe = LabelFrame(multirunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_1, fg=FRAME_TEXT_COLOR_1, text='STAGE 3', font=('Arial',13), width=338, height=460)
	setting3_labelframe.place(x=680,y=60)

	voltage1_labelframe = LabelFrame(setting1_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='VOLTAGE (VDC)', font=('Arial',12), width=238, height=100)
	voltage1_labelframe.place(x=45,y=85)
	timer1_labelframe = LabelFrame(setting1_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='RUN TIMER (min : sec)', font=('Arial',12), width=238, height=100)
	timer1_labelframe.place(x=45,y=235)
	twodot_label = Label(timer1_labelframe, fg=LABEL_TEXT_COLOR_3, bg=LABEL_BACKGROUND_COLOR_3, text =':', font=('Arial', 20))
...
#     autocap1_labelframe.place(x=10,y=218)
	...
	voltage2_labelframe = LabelFrame(setting2_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='VOLTAGE (VDC)', font=('Arial',12), width=238, height=100)
	voltage2_labelframe.place(x=47,y=85)
	timer2_labelframe = LabelFrame(setting2_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='RUN TIMER (min : sec)', font=('Arial',12), width=238, height=100)
	timer2_labelframe.place(x=47,y=235)
	twodot_label = Label(timer2_labelframe, fg=LABEL_TEXT_COLOR_3, bg=LABEL_BACKGROUND_COLOR_3, text =':', font=('Arial', 20))
	twodot_label.place(x=106, y=15)
...
#     autocap2_labelframe.place(x=10,y=218)
	...
	voltage3_labelframe = LabelFrame(setting3_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='VOLTAGE (VDC)', font=('Arial',12), width=238, height=100)
	voltage3_labelframe.place(x=47,y=85)
	timer3_labelframe = LabelFrame(setting3_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='RUN TIMER (min : sec)', font=('Arial',12), width=238, height=100)
	timer3_labelframe.place(x=47,y=235)
	twodot_label = Label(timer3_labelframe, fg=LABEL_TEXT_COLOR_3, bg=FRAME_BACKGROUND_COLOR_2, text =':', font=('Arial', 20))
	twodot_label.place(x=106, y=15)
...
#     autocap3_labelframe.place(x=10,y=218)
	...
	voltage1_entry = Entry(voltage1_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	voltage1_entry.place(x=84,y=12)
	voltage1_entry.insert(0, voltage1_set)
	m1_entry = Entry(timer1_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	m1_entry.place(x=31,y=12)
	m1_entry.insert(0, str('%02d'%m1_set))
	s1_entry = Entry(timer1_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
...
#     autocap1_entry.insert(0, 5)
	...
	voltage2_entry = Entry(voltage2_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	voltage2_entry.place(x=84,y=12)
	voltage2_entry.insert(0, voltage2_set)
	m2_entry = Entry(timer2_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	m2_entry.place(x=31,y=12)
	m2_entry.insert(0, str('%02d'%m2_set))
	s2_entry = Entry(timer2_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
...
#     autocap2_entry.insert(0, 5)
	...
	voltage3_entry = Entry(voltage3_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	voltage3_entry.place(x=84,y=12)
	voltage3_entry.insert(0, voltage3_set)
	m3_entry = Entry(timer3_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	m3_entry.place(x=31,y=12)
	m3_entry.insert(0, str('%02d'%m3_set))
	s3_entry = Entry(timer3_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
...
#     autocap3_entry.insert(0, 5)
	...
	automail_labelframe = LabelFrame(multirunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_2, text='EMAIL', width=685, height=68)
	automail_labelframe.place(x=222,y=526)

	mail_label = Label(automail_labelframe, bg=FRAME_BACKGROUND_COLOR_2, text='To:', font=('Arial, 15'))
	mail_label.place(x=250, y=7)
	mail_entry = Entry(automail_labelframe, justify='right',width=35, font=('Arial',13))
	mail_entry.place(x=290,y=7)
	...
	automail_on_button.place(x=70,y=-4)
	...
	automail_off_button.place(x=127,y=-4)
	if(account_active==0):
	...
	def run1_click():
		...
		if(voltage1_entry.get()=='' or voltage2_entry.get()=='' or voltage3_entry.get()==''):
			...
			global multirunscreen_labelframe0, naming_labelframe
			multirunscreen_labelframe0.destroy()
			naming_labelframe.destroy()

			multirunscreen_labelframe = LabelFrame(root, bg=FRAME_BACKGROUND_COLOR_2, width=1023, height=599)
			multirunscreen_labelframe.place(x=1,y=1)
			multirunscreen0_title_labelframe = LabelFrame(multirunscreen_labelframe, text="DEFAULT STAGE", font=('Arial', 13, 'bold'), bg='green yellow', width=168, height=148)
			multirunscreen0_title_labelframe.place(x=0,y=0)
			multirunscreen1_title_labelframe = LabelFrame(multirunscreen_labelframe, text="STAGE 1", font=('Arial', 13, 'bold'), bg='grey70', width=168, height=148)
			multirunscreen1_title_labelframe.place(x=0,y=149)
			multirunscreen2_title_labelframe = LabelFrame(multirunscreen_labelframe, text="STAGE 2", font=('Arial', 13, 'bold'), bg='grey70', width=168, height=148)
			multirunscreen2_title_labelframe.place(x=0,y=298)
			multirunscreen3_title_labelframe = LabelFrame(multirunscreen_labelframe, text="STAGE 3", font=('Arial', 13, 'bold'), bg='grey70', width=168, height=148)
			multirunscreen3_title_labelframe.place(x=0,y=447)

			voltage0_labelframe = LabelFrame(multirunscreen0_title_labelframe, font=('Arial', 13), bg='green yellow', width=140, height=45)
			voltage0_labelframe.place(x=11,y=5)
			timer0_labelframe = LabelFrame(multirunscreen0_title_labelframe, text="Time left", font=('Arial', 10), bg='green yellow', width=140, height=50)
			timer0_labelframe.place(x=11,y=60)
			voltage0_label = Label(voltage0_labelframe, fg ='red2', text=str(voltage0_set) + 'V / ' + str('%02d'%m0_raw) + ':' + str('%02d'%s0_raw), font=('Arial',15,'bold'), bg='green yellow')
			voltage0_label.place(x=13, y=6)
			m0_label = Label(timer0_labelframe, fg ='red2', text=str('%.02d'%m0_set), font=('Arial',15,'bold'), bg='green yellow')
			m0_label.place(x=33, y=-2)
			twodot0_label = Label(timer0_labelframe, fg ='red2', text=':', font=('Arial',15,'bold'), bg='green yellow')
			twodot0_label.place(x=61,y=-2)
			s0_label = Label(timer0_labelframe, fg ='red2', text=str('%.02d'%s0_set), font=('Arial',15,'bold'), bg='green yellow')
			s0_label.place(x=75, y=-2)

			voltage1_labelframe = LabelFrame(multirunscreen1_title_labelframe, font=('Arial', 13), bg='grey70', width=140, height=45)
			...
			voltage2_labelframe = LabelFrame(multirunscreen2_title_labelframe, font=('Arial', 13), bg='grey70', width=140, height=45)
			voltage2_labelframe.place(x=11,y=5)
			timer2_labelframe = LabelFrame(multirunscreen2_title_labelframe, text="Time left", font=('Arial', 10), bg='grey70', width=140, height=50)
			timer2_labelframe.place(x=11,y=60)
			voltage2_label = Label(voltage2_labelframe, fg ='red2', text=str(voltage2_set) + 'V / ' + str('%02d'%m2_raw) + ':' + str('%02d'%s2_raw), font=('Arial',15,'bold'), bg='grey70')
			voltage2_label.place(x=13, y=6)
			m2_label = Label(timer2_labelframe, fg ='red2', text=str('%.02d'%m2_set), font=('Arial',15,'bold'), bg='grey70')
			m2_label.place(x=33, y=-2)
			twodot2_label = Label(timer2_labelframe, fg ='red2', text=':', font=('Arial',15,'bold'), bg='grey70')
			twodot2_label.place(x=61,y=-2)
			s2_label = Label(timer2_labelframe, fg ='red2', text=str('%.02d'%s2_set), font=('Arial',15,'bold'), bg='grey70')
			s2_label.place(x=75, y=-2)

			voltage3_labelframe = LabelFrame(multirunscreen3_title_labelframe, font=('Arial', 13), bg='grey70', width=140, height=45)
			voltage3_labelframe.place(x=11,y=5)
			timer3_labelframe = LabelFrame(multirunscreen3_title_labelframe, text="Time left", font=('Arial', 10), bg='grey70', width=140, height=50)
			timer3_labelframe.place(x=11,y=60)
			voltage3_label = Label(voltage3_labelframe, fg ='red2', text=str(voltage3_set) + 'V / ' + str('%02d'%m3_raw) + ':' + str('%02d'%s3_raw), font=('Arial',15,'bold'), bg='grey70')
			voltage3_label.place(x=13, y=6)
			m3_label = Label(timer3_labelframe, fg ='red2', text=str('%.02d'%m3_set), font=('Arial',15,'bold'), bg='grey70')
			m3_label.place(x=33, y=-2)
			twodot3_label = Label(timer3_labelframe, fg ='red2', text=':', font=('Arial',15,'bold'), bg='grey70')
			twodot3_label.place(x=61,y=-2)
			s3_label = Label(timer3_labelframe, fg ='red2', text=str('%.02d'%s3_set), font=('Arial',15,'bold'), bg='grey70')
			s3_label.place(x=75, y=-2)

			preview_labelframe = LabelFrame(multirunscreen_labelframe, bg='black', fg='red', text="◉ MONITOR", font=("Arial",13,'bold'), width=849, height=530)
			preview_labelframe.place(x=169,y=0)

			limit1_canvas = Canvas(preview_labelframe, bg='grey70', bd=0, width=84, height=498)
			limit1_canvas.place(x=1,y=4)
			limit2_canvas = Canvas(preview_labelframe, bg='grey70', bd=0, width=84, height=498)
			limit2_canvas.place(x=759,y=4)
...
#                         wb.save(path_name + 'result.xlsx')
					...
					tprocess_label['font'] = ('Arial',20, 'bold')
					tprocess_label['text'] = 'COMPLETED'
					tprocess_label['fg'] = 'lawn green'
					tprocess_label.place(x=323,y=237)
			...
			button_labelframe = LabelFrame(multirunscreen_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=854, height=100)
			button_labelframe.place(x=168,y=529)

			para_labelframe = LabelFrame(button_labelframe, bg='grey15', width=80, height=55)
			# ~ para_labelframe.place(x=3,y=4)
			para_labelframe.pack(padx=2, pady=0, side=LEFT)
			present_voltage_label = Label(para_labelframe, font=('Arial',15,'bold'), text ='', fg='lawn green', bg='grey15')
			present_voltage_label.pack(padx=2, pady=10)
			present_current_label = Label(para_labelframe, font=('Arial',9,'bold'), fg='grey15', bg='red')
			# present_current_label.pack(padx=15, pady=2)
			
			cam_labelframe = LabelFrame(button_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=150, height=55)
			cam_labelframe.pack(padx=10, pady=0, side=LEFT)
			
			def cam_mode1_clicked():
				global camera, camera_mode
				camera_mode = 1
				cam_mode2_button['background'] = 'grey75'
				cam_mode1_button['background'] = 'lawngreen'
				camera.stop_preview()
				camera.framerate = 1
				camera.exposure_mode = 'sports'
				sleep(1)
				camera_preview()
			def cam_mode2_clicked():
				global camera, camera_mode
				camera_mode = 2 
				cam_mode1_button['background'] = 'grey75'
				cam_mode2_button['background'] = 'lawngreen'
				camera.stop_preview()
				camera.framerate = 3
				camera.exposure_mode = 'sports'
				sleep(1)
			...
			cam_mode1_button = Button(cam_labelframe, bg='lawn green', bd=1, text='MODE 1',font=("Arial",12,'bold'), command=cam_mode1_clicked)
			cam_mode1_button.pack(padx=2, pady=2, side=LEFT)
			cam_mode2_button = Button(cam_labelframe, bg='grey75', bd=1, text='MODE 2',font=("Arial",12,'bold'), command=cam_mode2_clicked)
			cam_mode2_button.pack(padx=2, pady=2, side=LEFT)
	...
	#                         wb.save(path_name + 'result.xlsx')
					...
					if(running==1):
						...
						GPIO.output(RELAY_PIN, GPIO.HIGH)
						camera_preview()
			capture_button = Button(button_labelframe, bg=BUTTON_BACKGROUND_COLOR_3, bd=1, text='CAPTURE',font=("10",13,'bold'), width=18, height=2, command=capture_click)
			# ~ capture_button.place(x=210,y=3)
			capture_button.pack(padx=0, pady=2, side=LEFT)
			stop_button = Button(button_labelframe, bg=BUTTON_BACKGROUND_COLOR_4, bd=1, text='STOP',font=("10",13,'bold'), width=18, height=2, command =stop_click)
			# ~ stop_button.place(x=427,y=3)
			stop_button.pack(padx=2, pady=2, side=LEFT)
	...
	back_button = Button(multirunscreen_labelframe0, bd=1, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), text='BACK', width=12, height=3, command=back_click)
	back_button.place(x=0,y=532)
	save_button = Button(multirunscreen_labelframe0, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), bd=1,text='SAVE', width=12, height=3, command=save_click)
	save_button.place(x=109,y=532)
	run1_button = Button(multirunscreen_labelframe0, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), bd=1,text='RUN', width=12, height=3, command=run1_click)
	run1_button.place(x=907,y=532)
...
def oneStepRunScreen():
	...
	global onerunscreen_labelframe0
	onerunscreen_labelframe0 = LabelFrame(root, bg=FRAME_BACKGROUND_COLOR_1, width=1023, height=599)
	onerunscreen_labelframe0.place(x=1,y=1)
	onerunscreen_title_label =  Label(onerunscreen_labelframe0, text="SETTINGS", font=("Arial",16, "bold"), fg=LABEL_TEXT_COLOR_1, bg=LABEL_BACKGROUND_COLOR_1, width=84, height=2)
	onerunscreen_title_label.place(x=3,y=1)

	setting1_labelframe = LabelFrame(onerunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_1, width=337, height=460)
	setting1_labelframe.place(x=1,y=60)
	setting2_labelframe = LabelFrame(onerunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_1, width=337, height=460)
	setting2_labelframe.place(x=340,y=60)
	setting3_labelframe = LabelFrame(onerunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_1, width=337, height=460)
	setting3_labelframe.place(x=680,y=60)

	voltage_labelframe = LabelFrame(setting2_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='VOLTAGE (VDC)', font=('Arial',12), width=238, height=100)
	voltage_labelframe.place(x=47,y=25)
	timer_labelframe = LabelFrame(setting2_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='RUN TIMER (min : sec)', font=('Arial',12), width=238, height=100)
	timer_labelframe.place(x=47,y=175)
	autocap_labelframe = LabelFrame(setting2_labelframe, bg=FRAME_BACKGROUND_COLOR_2, fg=FRAME_TEXT_COLOR_2, text='CAPTURE TIMER (min)', font=('Arial',12), width=238, height=100)
	autocap_labelframe.place(x=47,y=325)
	twodot_label = Label(timer_labelframe, fg=LABEL_TEXT_COLOR_3, bg=FRAME_BACKGROUND_COLOR_2, text =':', font=('Arial', 20))
	twodot_label.place(x=106, y=15)

	voltage_entry = Entry(voltage_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	voltage_entry.place(x=84,y=12)
	voltage_entry.insert(0, voltage_set)
	m_entry = Entry(timer_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	m_entry.place(x=31,y=12)
	m_entry.insert(0, str('%02d'%m_set))
	s_entry = Entry(timer_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	s_entry.place(x=135,y=12)
	s_entry.insert(0, str('%02d'%s_set))
	autocap_entry = Entry(autocap_labelframe, fg='red', justify='center',width=3, font=('Arial',25))
	autocap_entry.place(x=84,y=12)
	autocap_entry.insert(0, auto_capture_timer_set)

	automail_labelframe = LabelFrame(onerunscreen_labelframe0, bg=FRAME_BACKGROUND_COLOR_2, text='EMAIL', width=685, height=68)
	automail_labelframe.place(x=222,y=526)
	...
	def run1_click():
		...
		if(voltage_entry.get()==''):
			...
			global onerunscreen_labelframe0, naming_labelframe
			onerunscreen_labelframe0.destroy()
			naming_labelframe.destroy()

			onerunscreen_labelframe = LabelFrame(root, bg='grey85', width=1023, height=599)
			onerunscreen_labelframe.place(x=1,y=1)
			multirunscreen0_title_labelframe = LabelFrame(onerunscreen_labelframe, text="DEFAULT STAGE", font=('Arial', 13, 'bold'), bg='green yellow', width=168, height=148)
			multirunscreen0_title_labelframe.place(x=0,y=0)
			multirunscreen1_title_labelframe = LabelFrame(onerunscreen_labelframe, text="STAGE 1", font=('Arial', 13, 'bold'), bg='grey70', width=168, height=148)
			multirunscreen1_title_labelframe.place(x=0,y=149)
...
#                         wb.save(path_name + 'result.xlsx')
			...
			button_labelframe = LabelFrame(onerunscreen_labelframe, bg='grey90', width=854, height=100)
			button_labelframe.place(x=168,y=529)
			...
			cam_labelframe = LabelFrame(button_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=150, height=55)
			cam_labelframe.pack(padx=25, pady=0, side=LEFT)
	...
	#                         wb.save(path_name + 'result.xlsx')
			...
			capture_button = Button(button_labelframe, bg=BUTTON_BACKGROUND_COLOR_3, bd=1, text='CAPTURE',font=("10",13,'bold'), width=18, height=2, command=capture_click)
			# ~ capture_button.place(x=210,y=3)
			capture_button.pack(padx=2, pady=2, side=LEFT)
			stop_button = Button(button_labelframe, bg=BUTTON_BACKGROUND_COLOR_4, bd=1, text='STOP',font=("10",13,'bold'), width=18, height=2, command =stop_click)
			# ~ stop_button.place(x=427,y=3)
			stop_button.pack(padx=2, pady=2, side=LEFT)
	...
	back_button = Button(onerunscreen_labelframe0, bd=1, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), text='BACK', width=12, height=3, command = back_click)
	back_button.place(x=0,y=532)
	save_button = Button(onerunscreen_labelframe0, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), bd=1,text='SAVE', width=12, height=3, command = save_click)
	save_button.place(x=109,y=532)
	run1_button = Button(onerunscreen_labelframe0, bg=BUTTON_BACKGROUND_COLOR_1, font=('Arial',10, 'bold'), bd=1,text='RUN', width=12, height=3, command = run1_click)
	run1_button.place(x=907,y=532)
...
def trial_expired():
	...
	active_code_entry = Entry(trial_work_frame, width=30, font=('Arial',14))
