...
def namingScreen():
    ...
    well_entry_list_17 = list(range(17))
    number_button_list_17 = list(range(17))
    n=0
    for i in range(0,17):
    ...
    well_entry_list_17[12].bind("<Return>",lambda funct:well_entry_list_17[0].focus_set())
...
#     well_entry_list_26[i].bind("<Return>", ok_clicked_0)
    ...
    number_of_wells_combobox['values'] = ('17 wells', '26 wells')
    ...
    def next_click():
        ...
        if(number_of_wells_combobox.current() == 0):
            num_well = 17
            well_name_list_17 = list(range(17))
            for i in range(0,17):
