...
#             menu_labelframe.place_forget()
			...
			control0_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=100, height=70)
			control0_labelframe.place(x=18, y=340)
			control1_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=80, height=70)
			control1_labelframe.place(x=214,y=340)
			control2_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=237, height=70)
			control2_labelframe.place(x=342, y=340)
			control3_labelframe = LabelFrame(viewresults_labelframe, bg=FRAME_BACKGROUND_COLOR_1, width=100, height=70)
			control3_labelframe.place(x=579, y=340)
...
#                     final_img.save(name+'.png', 'png')
			...
			firstband_label = Label(control0_labelframe, text="First band", font=('Courier', 10))
			firstband_label.grid(row=0, column=0, padx=7, pady=3, sticky=S) 
			lastband_label = Label(control0_labelframe, text="Last band ", font=('Courier', 10))
			lastband_label.grid(row=1, column=0, padx=7, pady=3) 
			
			firstband_entry = Entry(control0_labelframe, justify='right', width=6, font=('Courier',15))
			firstband_entry.grid(row=0, column=1, padx=8, pady=3)
			firstband_entry.insert(0, 2000)
			lastband_entry = Entry(control0_labelframe, justify='right', width=6, font=('Courier',15))
			lastband_entry.grid(row=1, column=1, padx=8, pady=3)
